...
model = model_from_json(open("model_arch.json", "r").readcler())
model.load_weights('model_weights.h5')
# model = load_model('static\Fer2013.h5')
face_haar_cascade = cv2.CascadeClassifier('/Users/saagarrajtiwari/Documents/CSULB/Semester-2/Pattern Recognition/Final Project/try2/haarcascade_frontalface_default.xml')
